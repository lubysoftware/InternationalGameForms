...
public class Constants : MonoBehaviour
{
    ...
    public const string URL_DATABASE = "https://0b12-138-99-195-218.ngrok.io/";
    public const string URL_UPLOAD_MEDIA = "https://0b12-138-99-195-218.ngrok.io/file-upload";
}
