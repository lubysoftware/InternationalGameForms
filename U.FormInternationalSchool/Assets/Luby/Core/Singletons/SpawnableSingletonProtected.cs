...
{
    /// <summary>
    /// <para>Singleton that spawns an Instance whenever there is not one. That Instance is protected.</para>
    /// <remarks>
    ...
    public class SpawnableSingletonProtected<T> : MonoBehaviour where T : MonoBehaviour
    {
